...
function Card({title, rating, description, featured_image, items=['item1', 'item2', 'item 3']}) {
  ...
  return (
    ...
    <div className={`card group flex flex-col  h-[25rem] w-[20rem] bg-black relative backface-hidden rounded-3xl transform-3d border-2 perspective:1000px ${clicked ? 'rotate-y-180' : 'rotate-y-0'} `}>
            {/* <div className='absolute h-full w-full border-2 inset-0 from-white via-transparent to-transparent ' ></div> */}
            <img className='h-full w-full object-cover rounded-3xl z-0 opacity-[85%]' src={featured_image || "https://static.spotapps.co/website_images/ab_websites/174603_website_v1/menu.jpg"}/>
